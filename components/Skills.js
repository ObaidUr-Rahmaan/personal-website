...
const Skills = () => {
  return (
    <div id="skills" className="w-full p-2 mb-40 lg:h-screen">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="p-6 duration-300 ease-in shadow-xl rounded-xl hover:scale-105">
            <div className="grid items-center justify-center grid-cols-2 gap-4">
              <div className="m-auto">
                <Image
                  src="/../public/assets/skills/terraform.png"
                  width="64px"
                  height="64px"
                  alt="/"
                />
          ...
          <div className="p-6 duration-300 ease-in shadow-xl rounded-xl hover:scale-105">
            <div className="grid items-center justify-center grid-cols-2 gap-4">
              <div className="m-auto">
                <Image
                  src="/../public/assets/skills/nomad.png"
                  width="64px"
                  height="64px"
                  alt="/"
                />
          ...
          <div className="p-6 duration-300 ease-in shadow-xl rounded-xl hover:scale-105">
            <div className="grid items-center justify-center grid-cols-2 gap-4">
              <div className="m-auto">
                <Image
                  src="/../public/assets/skills/puppet.png"
                  width="64px"
                  height="64px"
                  alt="/"
                />
          ...
          <div className="p-6 duration-300 ease-in shadow-xl rounded-xl hover:scale-105">
            <div className="grid items-center justify-center grid-cols-2 gap-4">
              <div className="m-auto">
                <Image
                  src="/../public/assets/skills/nginx.png"
                  width="64px"
                  height="64px"
                  alt="/"
                />
          ...
          <div className="p-6 duration-300 ease-in shadow-xl rounded-xl hover:scale-105">
            <div className="grid items-center justify-center grid-cols-2 gap-4">
              <div className="m-auto">
                <Image
                  src="/../public/assets/skills/kafka.png"
                  width="64px"
                  height="64px"
                  alt="/"
                />
          ...
          <div className="p-6 duration-300 ease-in shadow-xl rounded-xl hover:scale-105">
            <div className="grid items-center justify-center grid-cols-2 gap-4">
              <div className="m-auto">
                <Image
                  src="/../public/assets/skills/elk.png"
                  width="225px"
                  height="64px"
                  alt="/"
                />
          ...
          <div className="p-6 duration-300 ease-in shadow-xl rounded-xl hover:scale-105">
            <div className="grid items-center justify-center grid-cols-2 gap-4">
              <div className="m-auto">
                <Image
                  src="/../public/assets/skills/grafana.png"
                  width="64px"
                  height="64px"
                  alt="/"
                />
